              ...
              {secondaryNavigation.map((item) => (
                <li key={item.name}>
                  <a
                    ...
                    className={cn(
                      item.current
                        ? "text-vodafone-600 bg-gray-50"
                        : "hover:text-vodafone-600 text-gray-700 hover:bg-gray-50",
                  ...
                  >
                    <item.icon
                      ...
                      className={cn(
                        item.current
                          ? "text-vodafone-600"
                          : "group-hover:text-vodafone-600 text-gray-400",
                        "size-6 shrink-0",
                      )}
                    />
                    {item.name}
          ...
          <div className="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
            ...
            <div>
              ...
              <div className="flex border-t border-gray-100 pt-6">
                <button
                  type="button"
                  className="text-vodafone-600 hover:text-vodafone-500 text-sm/6 font-semibold"
                >
